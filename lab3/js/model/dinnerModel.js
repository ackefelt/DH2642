...
var DinnerModel = function() { 
	...
	this.getDishPrice = function(id) {
		var dishPrice = 0;
		var ingredientsA = this.getDish(id).ingredients;
		for(i in ingredientsA){
			dishPrice += ingredientsA[i].price;
		}
	...
	this.getTotalMenuPrice = function() {
		var totalPrice = 0;
		var ingredientsL = this.getAllIngredients();
		for(i in ingredientsL) {
			for(object in ingredientsL[i]) {
				totalPrice += ingredientsL[i][object].price;
			}
		}
